...
**v4.1** — правка конфигов CMS независимо от типа кавычек (define ("DBPASS", 'pass')),
проверка подключения к БД после замены, вычистка DEFINER из дампа (ошибка 1142 у триггеров).
